...
var author$project$Main$emptyModel = {allCombinations: _List_Nil, allCount: 0, limit: 100, parsed: elm$core$Maybe$Nothing, pattern: '', prefixCombinations: _List_Nil, prefixCount: 0, prefixOnly: false};
var author$project$Main$initPattern = '[(all [[of] the]|the)] permissions (from|of) %players%';
var author$project$PatternParser$Empty = {$: 'Empty'};
var author$project$PatternParser$Grouped = function (a) {
	return {$: 'Grouped', a: a};
};
var author$project$PatternParser$Regex = function (a) {
	return {$: 'Regex', a: a};
};
var author$project$PatternParser$WS = {$: 'WS'};
var author$project$PatternParser$And = F2(
	function (a, b) {
		return {$: 'And', a: a, b: b};
	});
...
var author$project$PatternParser$andCombinations = F2(
		...
		if (!lefts.b) {
			...
			return A2(
				...
				A2(
					elm$core$List$map,
					function (r) {
						return A2(author$project$PatternParser$And, l, r);
					},
					rights),
				A2(author$project$PatternParser$andCombinations, ls, rights));
		}
	});
var author$project$PatternParser$combinations = function (pattern) {
	switch (pattern.$) {
		case 'Empty':
			return _List_Nil;
		case 'WS':
			return _List_fromArray(
				[author$project$PatternParser$WS]);
		case 'Literal':
			return _List_fromArray(
				[pattern]);
		case 'And':
			...
			var right = pattern.b;
			return A2(
				author$project$PatternParser$andCombinations,
				author$project$PatternParser$combinations(left),
				author$project$PatternParser$combinations(right));
		case 'Optional':
			var pat = pattern.a;
			return A2(
				elm$core$List$cons,
				author$project$PatternParser$Empty,
				author$project$PatternParser$combinations(pat));
		case 'Grouped':
			var pat = pattern.a;
			return A2(
				elm$core$List$map,
				author$project$PatternParser$Grouped,
				author$project$PatternParser$combinations(pat));
		case 'Or':
			var left = pattern.a;
			var right = pattern.b;
		...
		default:
			...
			return A2(
				elm$core$List$map,
				author$project$PatternParser$Regex,
				author$project$PatternParser$combinations(pat));
	}
};
var elm$core$Basics$append = _Utils_append;
var author$project$PatternParser$toMatchedString = function (pattern) {
	toMatchedString:
	while (true) {
		switch (pattern.$) {
			case 'Empty':
			...
			case 'And':
				...
				var right = pattern.b;
				return _Utils_ap(
					author$project$PatternParser$toMatchedString(left),
					author$project$PatternParser$toMatchedString(right));
			case 'Optional':
				var pat = pattern.a;
			...
			default:
				var pat = pattern.a;
				return '<' + (author$project$PatternParser$toMatchedString(pat) + '>');
		}
	}
};
var author$project$PatternParser$mapToString = function (patterns) {
	return A2(elm$core$List$map, author$project$PatternParser$toMatchedString, patterns);
};
var author$project$PatternParser$Optional = function (a) {
	return {$: 'Optional', a: a};
};
var author$project$PatternParser$Expression = function (a) {
...
var author$project$PatternParser$expression = A2(
	elm$parser$Parser$keeper,
	A2(
		elm$parser$Parser$ignorer,
		elm$parser$Parser$succeed(author$project$PatternParser$Expression),
	...
	A2(
		...
		elm$parser$Parser$symbol('%')));
var author$project$PatternParser$Literal = function (a) {
	return {$: 'Literal', a: a};
};
...
var author$project$PatternParser$whitespaceChars = elm$core$Set$fromList(
	_List_fromArray(
		[
			_Utils_chr(' '),
			_Utils_chr('\u000d'),
...
var author$project$PatternParser$specialChars = function () {
	var reserved = elm$core$Set$fromList(
		_List_fromArray(
			[
				_Utils_chr('('),
				_Utils_chr(')'),
	...
	return A2(elm$core$Set$union, reserved, author$project$PatternParser$whitespaceChars);
}();
...
var author$project$PatternParser$isSpecial = function (_char) {
	return A2(elm$core$Set$member, _char, author$project$PatternParser$specialChars);
};
var author$project$PatternParser$isLiteral = function (_char) {
	return !author$project$PatternParser$isSpecial(_char);
};
...
var author$project$PatternParser$literal = A2(
	elm$parser$Parser$map,
	author$project$PatternParser$Literal,
	elm$parser$Parser$getChompedString(
		A2(
			elm$parser$Parser$ignorer,
			A2(
				...
				elm$parser$Parser$chompIf(author$project$PatternParser$isLiteral)),
			elm$parser$Parser$chompWhile(author$project$PatternParser$isLiteral))));
var author$project$PatternParser$reduceAndSequence = function (patterns) {
	if (!patterns.b) {
		return author$project$PatternParser$Empty;
	} else {
		if (!patterns.b.b) {
			var p = patterns.a;
			return p;
			...
			var ps = patterns.b;
			return A2(
				author$project$PatternParser$And,
				p,
				author$project$PatternParser$reduceAndSequence(ps));
		}
	}
};
var author$project$PatternParser$Or = F2(
	function (a, b) {
		return {$: 'Or', a: a, b: b};
	});
var author$project$PatternParser$reduceOrSequence = function (patterns) {
	if (!patterns.b) {
		return author$project$PatternParser$Empty;
	} else {
		if (!patterns.b.b) {
			...
			var ps = patterns.b;
			return A2(
				author$project$PatternParser$Or,
				p,
				author$project$PatternParser$reduceOrSequence(ps));
		}
	}
};
var author$project$PatternParser$isWhitespace = function (_char) {
	return A2(elm$core$Set$member, _char, author$project$PatternParser$whitespaceChars);
};
var author$project$PatternParser$whitespace = A2(
	elm$parser$Parser$map,
	function (_n0) {
		return author$project$PatternParser$WS;
	},
	A2(
		elm$parser$Parser$ignorer,
		A2(
			elm$parser$Parser$ignorer,
			elm$parser$Parser$succeed(_Utils_Tuple0),
			elm$parser$Parser$chompIf(author$project$PatternParser$isWhitespace)),
		elm$parser$Parser$chompWhile(author$project$PatternParser$isWhitespace)));
...
var author$project$PatternParser$andSequenceHelp = function (patterns) {
				...
				elm$parser$Parser$succeed(
					function (p) {
						return elm$parser$Parser$Loop(
							A2(elm$core$List$cons, p, patterns));
					}),
				author$project$PatternParser$cyclic$single()),
				A2(
				elm$parser$Parser$map,
				function (_n0) {
...
function author$project$PatternParser$cyclic$single() {
	return elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				author$project$PatternParser$whitespace,
				author$project$PatternParser$literal,
				author$project$PatternParser$cyclic$optional(),
				author$project$PatternParser$cyclic$grouped(),
				author$project$PatternParser$expression,
				author$project$PatternParser$cyclic$regex()
			]));
}
function author$project$PatternParser$cyclic$regex() {
	return A2(
		elm$parser$Parser$keeper,
		A2(
			elm$parser$Parser$ignorer,
			elm$parser$Parser$succeed(author$project$PatternParser$Regex),
			elm$parser$Parser$symbol('<')),
		A2(
			elm$parser$Parser$ignorer,
			author$project$PatternParser$cyclic$nested(),
			elm$parser$Parser$symbol('>')));
}
function author$project$PatternParser$cyclic$optional() {
	return A2(
		elm$parser$Parser$keeper,
		A2(
			elm$parser$Parser$ignorer,
			elm$parser$Parser$succeed(author$project$PatternParser$Optional),
			elm$parser$Parser$symbol('[')),
		A2(
			elm$parser$Parser$ignorer,
			author$project$PatternParser$cyclic$nested(),
...
function author$project$PatternParser$cyclic$grouped() {
	return A2(
		elm$parser$Parser$keeper,
		A2(
			elm$parser$Parser$ignorer,
			elm$parser$Parser$succeed(author$project$PatternParser$Grouped),
			elm$parser$Parser$symbol('(')),
		A2(
			elm$parser$Parser$ignorer,
			author$project$PatternParser$cyclic$nested(),
...
function author$project$PatternParser$cyclic$nested() {
	return author$project$PatternParser$cyclic$or();
}
function author$project$PatternParser$cyclic$or() {
	return A2(
		elm$parser$Parser$map,
		author$project$PatternParser$reduceOrSequence,
		author$project$PatternParser$cyclic$orSequence());
}
function author$project$PatternParser$cyclic$orSequence() {
	return elm$parser$Parser$sequence(
		{
			end: '',
			item: author$project$PatternParser$cyclic$and(),
			separator: '|',
...
function author$project$PatternParser$cyclic$and() {
	return A2(
		elm$parser$Parser$map,
		author$project$PatternParser$reduceAndSequence,
		author$project$PatternParser$cyclic$andSequence());
}
function author$project$PatternParser$cyclic$andSequence() {
	return A2(elm$parser$Parser$loop, _List_Nil, author$project$PatternParser$andSequenceHelp);
}
try {
	var author$project$PatternParser$single = author$project$PatternParser$cyclic$single();
	author$project$PatternParser$cyclic$single = function () {
		return author$project$PatternParser$single;
	};
	var author$project$PatternParser$regex = author$project$PatternParser$cyclic$regex();
	author$project$PatternParser$cyclic$regex = function () {
		return author$project$PatternParser$regex;
	};
	var author$project$PatternParser$optional = author$project$PatternParser$cyclic$optional();
	author$project$PatternParser$cyclic$optional = function () {
		return author$project$PatternParser$optional;
	};
	var author$project$PatternParser$grouped = author$project$PatternParser$cyclic$grouped();
	author$project$PatternParser$cyclic$grouped = function () {
		return author$project$PatternParser$grouped;
	};
	var author$project$PatternParser$nested = author$project$PatternParser$cyclic$nested();
	author$project$PatternParser$cyclic$nested = function () {
		return author$project$PatternParser$nested;
	};
	var author$project$PatternParser$or = author$project$PatternParser$cyclic$or();
	author$project$PatternParser$cyclic$or = function () {
		return author$project$PatternParser$or;
	};
	var author$project$PatternParser$orSequence = author$project$PatternParser$cyclic$orSequence();
	author$project$PatternParser$cyclic$orSequence = function () {
		return author$project$PatternParser$orSequence;
	};
	var author$project$PatternParser$and = author$project$PatternParser$cyclic$and();
	author$project$PatternParser$cyclic$and = function () {
		return author$project$PatternParser$and;
	};
	var author$project$PatternParser$andSequence = author$project$PatternParser$cyclic$andSequence();
	author$project$PatternParser$cyclic$andSequence = function () {
		return author$project$PatternParser$andSequence;
	};
} catch ($) {
throw 'Some top-level definitions from `PatternParser` are causing infinite recursion:\n\n  ┌─────┐\n  │    single\n  │     ↓\n  │    regex\n  │     ↓\n  │    optional\n  │     ↓\n  │    grouped\n  │     ↓\n  │    nested\n  │     ↓\n  │    or\n  │     ↓\n  │    orSequence\n  │     ↓\n  │    and\n  │     ↓\n  │    andSequence\n  │     ↓\n  │    andSequenceHelp\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.0/halting-problem to learn how to fix it!';}
...
var author$project$PatternParser$parser = A2(
	elm$parser$Parser$keeper,
	elm$parser$Parser$succeed(elm$core$Basics$identity),
	A2(elm$parser$Parser$ignorer, author$project$PatternParser$nested, elm$parser$Parser$end));
...
var author$project$PatternParser$parse = function (str) {
	var _n0 = A2(elm$parser$Parser$run, author$project$PatternParser$parser, str);
	if (_n0.$ === 'Ok') {
		var pattern = _n0.a;
...
var author$project$PatternParser$toList = function (pattern) {
	switch (pattern.$) {
		case 'Empty':
			return _List_Nil;
		case 'And':
			...
			return A2(
				elm$core$List$append,
				author$project$PatternParser$toList(left),
				author$project$PatternParser$toList(right));
		default:
			return _List_fromArray(
				[pattern]);
	}
};
var author$project$PatternParser$untilFirstHelper = function (patterns) {
	untilFirstHelper:
	while (true) {
		if (!patterns.b) {
			return _List_Nil;
			...
			switch (p.$) {
				...
				case 'WS':
					return A2(
						elm$core$List$cons,
						p,
						author$project$PatternParser$untilFirstHelper(ps));
				case 'Optional':
					return A2(
						elm$core$List$cons,
						p,
...
var author$project$PatternParser$untilFirstRequired = function (pattern) {
	return author$project$PatternParser$reduceAndSequence(
		author$project$PatternParser$untilFirstHelper(
			author$project$PatternParser$toList(pattern)));
};
...
var author$project$Main$updateModel = F2(
	function (model, pattern) {
		var parsed = function () {
			var _n2 = author$project$PatternParser$parse(pattern);
			if (_n2.$ === 'Ok') {
				var parsedPattern = _n2.a;
				return elm$core$Maybe$Just(parsedPattern);
			} else {
				return elm$core$Maybe$Nothing;
			}
		}();
		var untilRequiredCombs = function () {
			if (parsed.$ === 'Just') {
				var pat = parsed.a;
				return author$project$PatternParser$mapToString(
					author$project$PatternParser$combinations(
						author$project$PatternParser$untilFirstRequired(pat)));
			} else {
				return _List_Nil;
			}
		}();
		...
		return _Utils_update(
			model,
			{
				...
				allCount: elm$core$List$length(combs),
				parsed: parsed,
				pattern: pattern,
				prefixCombinations: untilRequiredCombs,
				prefixCount: elm$core$List$length(untilRequiredCombs)
			});
	});
...
var author$project$Main$labelElement = function (name) {
	return A2(
...
var author$project$Main$allCount = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$row,
		_List_Nil,
		_List_fromArray(
			[
				author$project$Main$labelElement('All Combinations'),
				mdgriffith$elm_ui$Element$text(
				elm$core$String$fromInt(model.allCount))
			]));
};
...
var author$project$Main$combinationsOutput = function (model) {
	var patterns = function () {
		var _n0 = model.prefixOnly;
		if (!_n0) {
			return model.allCombinations;
		} else {
			return model.prefixCombinations;
		}
	}();
	var count = elm$core$List$length(patterns);
	var lines = (_Utils_cmp(count, model.limit) > 0) ? A2(
		elm$core$List$intersperse,
		'\n',
		A2(elm$core$List$take, model.limit, patterns)) : A2(elm$core$List$intersperse, '\n', patterns);
...
var author$project$Main$prefixCount = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$row,
		_List_Nil,
		_List_fromArray(
			[
				author$project$Main$labelElement('Prefix Combinations'),
				mdgriffith$elm_ui$Element$text(
				elm$core$String$fromInt(model.prefixCount))
			]));
};
...
var author$project$Main$results = function (model) {
	...
	var rounded = 3;
	var padding = 20;
	var color = A3(mdgriffith$elm_ui$Element$rgb, 0.95, 0.95, 0.95);
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						author$project$Main$allCount(model),
						author$project$Main$prefixCount(model)
					])),
				A2(
				mdgriffith$elm_ui$Element$el,
				_List_fromArray(
				...
				author$project$Main$combinationsOutput(model))
			]));
};
var author$project$Main$LimitChange = function (a) {
	return {$: 'LimitChange', a: a};
};
var author$project$Main$settingLabel = function (name) {
	return A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
...
var author$project$Main$limitOutput = function (model) {
	var labelName = 'Output Limit';
	return A2(
		mdgriffith$elm_ui$Element$row,
		_List_Nil,
		_List_fromArray(
			[
				author$project$Main$settingLabel(labelName),
				A2(
				mdgriffith$elm_ui$Element$Input$text,
				_List_Nil,
				{
					label: mdgriffith$elm_ui$Element$Input$labelHidden(labelName),
					onChange: author$project$Main$LimitChange,
					placeholder: elm$core$Maybe$Just(
						A2(
							mdgriffith$elm_ui$Element$Input$placeholder,
							_List_Nil,
							mdgriffith$elm_ui$Element$text('limit'))),
					text: elm$core$String$fromInt(model.limit)
				})
			]));
};
...
var author$project$Main$outputType = function (model) {
	var labelName = 'Prefix Only';
	return A2(
		mdgriffith$elm_ui$Element$row,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_Nil,
				{
					checked: model.prefixOnly,
					icon: mdgriffith$elm_ui$Element$Input$defaultCheckbox,
					label: mdgriffith$elm_ui$Element$Input$labelHidden(labelName),
					onChange: author$project$Main$ChangeShow
				})
			]));
};
...
var author$project$Main$patternInput = function (model) {
	var color = function () {
		var _n0 = model.parsed;
		if (_n0.$ === 'Just') {
			return A3(mdgriffith$elm_ui$Element$rgb, 1, 1, 1);
		} else {
			return A3(mdgriffith$elm_ui$Element$rgb, 1, 0.5, 0.5);
		}
	}();
	return A2(
		mdgriffith$elm_ui$Element$row,
		...
		_List_fromArray(
			[
				...
				{
					label: mdgriffith$elm_ui$Element$Input$labelHidden('Pattern'),
					onChange: author$project$Main$PatternChange,
					placeholder: elm$core$Maybe$Just(
						A2(
							mdgriffith$elm_ui$Element$Input$placeholder,
							_List_Nil,
							mdgriffith$elm_ui$Element$text('pattern'))),
					spellcheck: false,
					text: model.pattern
				})
			]));
...
var author$project$Main$settings = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				author$project$Main$patternInput(model),
				author$project$Main$limitOutput(model),
				author$project$Main$outputType(model)
			]));
};
...
var author$project$Main$title = A2(
	...
	_List_fromArray(
		[
			...
			A3(mdgriffith$elm_ui$Element$rgb, 0.4, 0.4, 0.3))
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[mdgriffith$elm_ui$Element$centerX]),
			mdgriffith$elm_ui$Element$text('Pattern Calculator'))
		]));
