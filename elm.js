...
var author$project$Main$andCombinations = F2(
		...
		if (!lefts.b) {
			...
			return A2(
				...
				A2(
					elm$core$List$map,
					function (r) {
						return A2(author$project$Main$And, l, r);
					},
					rights),
				A2(author$project$Main$andCombinations, ls, rights));
		}
	});
var author$project$Main$combinations = function (pattern) {
	switch (pattern.$) {
		case 'Empty':
			return _List_Nil;
		case 'WS':
		...
		case 'And':
			...
			var right = pattern.b;
			return A2(
				author$project$Main$andCombinations,
				author$project$Main$combinations(left),
				author$project$Main$combinations(right));
		case 'Optional':
			var pat = pattern.a;
			return A2(
				elm$core$List$cons,
...
var author$project$Main$Expression = function (a) {
...
var author$project$Main$expression = A2(
	elm$parser$Parser$keeper,
	A2(
		elm$parser$Parser$ignorer,
		elm$parser$Parser$succeed(author$project$Main$Expression),
...
var author$project$Main$whitespaceChars = elm$core$Set$fromList(
	_List_fromArray(
		[
			_Utils_chr(' '),
			_Utils_chr('\r'),
...
var author$project$Main$specialChars = function () {
	...
	return A2(elm$core$Set$union, reserved, author$project$Main$whitespaceChars);
}();
...
var author$project$Main$isSpecial = function (_char) {
	return A2(elm$core$Set$member, _char, author$project$Main$specialChars);
};
var author$project$Main$isLiteral = function (_char) {
	return !author$project$Main$isSpecial(_char);
};
...
var author$project$Main$literal = A2(
	elm$parser$Parser$map,
	author$project$Main$Literal,
	elm$parser$Parser$getChompedString(
		A2(
			elm$parser$Parser$ignorer,
			A2(
				...
				elm$parser$Parser$chompIf(author$project$Main$isLiteral)),
			elm$parser$Parser$chompWhile(author$project$Main$isLiteral))));
var author$project$Main$reduceAndSequence = function (patterns) {
	if (!patterns.b) {
		...
		if (!patterns.b.b) {
			...
			var ps = patterns.b;
			return A2(
				author$project$Main$And,
				p,
				author$project$Main$reduceAndSequence(ps));
		}
	}
};
...
var author$project$Main$reduceOrSequence = function (patterns) {
	if (!patterns.b) {
		return author$project$Main$Empty;
	} else {
		if (!patterns.b.b) {
			...
			return A2(
				...
				p,
				author$project$Main$reduceOrSequence(ps));
		}
	}
};
var author$project$Main$isWhitespace = function (_char) {
	return A2(elm$core$Set$member, _char, author$project$Main$whitespaceChars);
};
var author$project$Main$whitespace = A2(
	elm$parser$Parser$map,
	function (_n0) {
	...
	A2(
		...
		A2(
			elm$parser$Parser$ignorer,
			elm$parser$Parser$succeed(_Utils_Tuple0),
			elm$parser$Parser$chompIf(author$project$Main$isWhitespace)),
		elm$parser$Parser$chompWhile(author$project$Main$isWhitespace)));
...
var author$project$Main$andSequenceHelp = function (patterns) {
	return elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				...
				author$project$Main$cyclic$single()),
				A2(
				elm$parser$Parser$map,
				function (_n0) {
...
function author$project$Main$cyclic$single() {
	return elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				author$project$Main$whitespace,
				author$project$Main$literal,
				author$project$Main$cyclic$optional(),
				author$project$Main$cyclic$grouped(),
				author$project$Main$expression,
				author$project$Main$cyclic$regex()
			]));
}
function author$project$Main$cyclic$regex() {
	return A2(
		elm$parser$Parser$keeper,
		A2(
			elm$parser$Parser$ignorer,
			elm$parser$Parser$succeed(author$project$Main$Regex),
			elm$parser$Parser$symbol('<')),
		A2(
			elm$parser$Parser$ignorer,
			author$project$Main$cyclic$nested(),
			elm$parser$Parser$symbol('>')));
}
function author$project$Main$cyclic$optional() {
	return A2(
		elm$parser$Parser$keeper,
		A2(
			elm$parser$Parser$ignorer,
			elm$parser$Parser$succeed(author$project$Main$Optional),
			elm$parser$Parser$symbol('[')),
		A2(
			elm$parser$Parser$ignorer,
			author$project$Main$cyclic$nested(),
...
function author$project$Main$cyclic$grouped() {
	return A2(
		elm$parser$Parser$keeper,
		A2(
			elm$parser$Parser$ignorer,
			elm$parser$Parser$succeed(author$project$Main$Grouped),
			elm$parser$Parser$symbol('(')),
		A2(
			elm$parser$Parser$ignorer,
			author$project$Main$cyclic$nested(),
...
function author$project$Main$cyclic$nested() {
	return author$project$Main$cyclic$or();
}
function author$project$Main$cyclic$or() {
	return A2(
		elm$parser$Parser$map,
		author$project$Main$reduceOrSequence,
		author$project$Main$cyclic$orSequence());
}
function author$project$Main$cyclic$orSequence() {
	return elm$parser$Parser$sequence(
		{
			end: '',
			item: author$project$Main$cyclic$and(),
			separator: '|',
...
function author$project$Main$cyclic$and() {
	return A2(
		elm$parser$Parser$map,
		author$project$Main$reduceAndSequence,
		author$project$Main$cyclic$andSequence());
}
function author$project$Main$cyclic$andSequence() {
	return A2(elm$parser$Parser$loop, _List_Nil, author$project$Main$andSequenceHelp);
}
try {
	var author$project$Main$single = author$project$Main$cyclic$single();
	author$project$Main$cyclic$single = function () {
		return author$project$Main$single;
	};
	var author$project$Main$regex = author$project$Main$cyclic$regex();
	author$project$Main$cyclic$regex = function () {
		return author$project$Main$regex;
	};
	var author$project$Main$optional = author$project$Main$cyclic$optional();
	author$project$Main$cyclic$optional = function () {
		return author$project$Main$optional;
	};
	var author$project$Main$grouped = author$project$Main$cyclic$grouped();
	author$project$Main$cyclic$grouped = function () {
		return author$project$Main$grouped;
	};
	var author$project$Main$nested = author$project$Main$cyclic$nested();
	author$project$Main$cyclic$nested = function () {
		return author$project$Main$nested;
	};
	var author$project$Main$or = author$project$Main$cyclic$or();
	author$project$Main$cyclic$or = function () {
		return author$project$Main$or;
	};
	var author$project$Main$orSequence = author$project$Main$cyclic$orSequence();
	author$project$Main$cyclic$orSequence = function () {
		return author$project$Main$orSequence;
	};
	var author$project$Main$and = author$project$Main$cyclic$and();
	author$project$Main$cyclic$and = function () {
		return author$project$Main$and;
	};
	var author$project$Main$andSequence = author$project$Main$cyclic$andSequence();
	author$project$Main$cyclic$andSequence = function () {
		return author$project$Main$andSequence;
	};
} catch ($) {
...
var author$project$Main$parser = A2(
	...
	A2(elm$parser$Parser$ignorer, author$project$Main$nested, elm$parser$Parser$end));
...
var author$project$Main$parse = function (str) {
	var _n0 = A2(elm$parser$Parser$run, author$project$Main$parser, str);
	if (_n0.$ === 'Ok') {
		var pat = _n0.a;
		return pat;
	} else {
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$placeholder('limit'),
								elm$html$Html$Attributes$value(
								elm$core$String$fromInt(model.limit)),
								elm$html$Html$Events$onInput(author$project$Main$LimitChange)
							]),
						_List_Nil)
					])),
